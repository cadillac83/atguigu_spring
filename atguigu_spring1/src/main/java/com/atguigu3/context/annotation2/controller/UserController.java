package com.atguigu3.context.annotation2.controller;

import com.atguigu3.context.annotation2.service.UserService;
...
public class UserController {
    ...
    public void execute(){
        System.out.println("UserController22 execute……");
        userService.add();
    }
